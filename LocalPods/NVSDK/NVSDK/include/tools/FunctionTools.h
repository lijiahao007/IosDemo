...
///
+(NSString *)md5:(NSString *)str;//大写
+ (NSString *)md5String:(NSString *)str;//小写
...
+(int)isAPMode:(NSString *_Nullable)ssid __attribute__((deprecated("调用该方法时请注意要在非主线程调用,ssid:如果传nil，里面会自己获取,-1:获取不到ssid，0:非ap，1：旧平台，2：新平台，3：xvv")));//ssid:如果传nil，里面会自己获取 -1:没有ssid，0:非ap，1：旧平台，2：新平台，3：xvv
