...
//MARK: 录像文件大类型（新平台）（占uint32中[0,3]，按位组合）
#define IOT_REC_TYPE_ALL    15  //所有文件
#define IOT_REC_TYPE_AUTO   1   //自动录像
#define IOT_REC_TYPE_ALARM  2   //报警录像
...
#define NV_IPC_ACTION_STARLIGHT_OPEN            1001    //星光开
#define NV_IPC_ACTION_STARLIGHT_CLOSE           1002    //星光关
...
#define LANPASS_ACTION_VERIFY     1    //LanPass局域网鉴权
#define LANPASS_ACTION_CHANGE     2    //LanPass局域网密码更改
#define LANPASS_ACTION_RESET_RDH  3   //LanPass局域网密码重置动态凭证RDH生成
#define LANPASS_ACTION_RESET      4   //LanPass局域网密码重置
...
typedef enum :NSInteger{
    DeviceSharePreview       = 31, //预览
    DeviceShareTFPlayback    = 30, //sd回放
    DeviceShareConfig        = 29, //远程配置
    DeviceShareIntercomVoice = 28, //对讲监听
    DeviceShareAlarmMessage  = 27, //报警消息
}DeviceSharePermssion;
