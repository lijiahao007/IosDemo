...
#include "convert_argb.h"  // For kYuvI601Constants
...
// 0x7e80 = (66 + 129 + 25) * -128 + 0x1000 (for +16) and 0x0080 for round2.
...
// LIBYUV_RGBTOU_TRUNCATE mimics x86 code that does not round2.
...
#define UB 129 /* round2(2.018 * 64) */
#else
#define UB 128 /* max(128, round2(2.018 * 64)) */
#endif
#define UG 25  /* round2(0.391 * 64) */
#define VG 52  /* round2(0.813 * 64) */
#define VR 102 /* round2(1.596 * 64) */

// Y contribution to R,G,B.  Scale and bias.
#define YG 18997 /* round2(1.164 * 64 * 256 * 256 / 257) */
...
// U and V contributions to R,G,B.
#define UB 113 /* round2(1.77200 * 64) */
#define UG 22  /* round2(0.34414 * 64) */
#define VG 46  /* round2(0.71414 * 64) */
#define VR 90  /* round2(1.40200 * 64) */

// Y contribution to R,G,B.  Scale and bias.
#define YG 16320 /* round2(1.000 * 64 * 256 * 256 / 257) */
#define YB 32    /* 64 / 2 */
...
#define UB 135 /* round2(2.112 * 64) */
#else
#define UB 128 /* max(128, round2(2.112 * 64)) */
#endif
#define UG 14  /* round2(0.213 * 64) */
#define VG 34  /* round2(0.533 * 64) */
#define VR 115 /* round2(1.793 * 64) */
...
// U and V contributions to R,G,B.
#define UB 119 /* round2(1.8556 * 64) */
#define UG 12  /* round2(0.18732 * 64) */
#define VG 30  /* round2(0.46812 * 64) */
#define VR 101 /* round2(1.5748 * 64) */

// Y contribution to R,G,B.  Scale and bias.  (same as jpeg)
#define YG 16320 /* round2(1 * 64 * 256 * 256 / 257) */
#define YB 32    /* 64 / 2 */
...
#define UB 137 /* round2(2.142 * 64) */
#else
#define UB 128 /* max(128, round2(2.142 * 64)) */
#endif
#define UG 12  /* round2(0.187326 * 64) */
#define VG 42  /* round2(0.65042 * 64) */
#define VR 107 /* round2(1.67867 * 64) */

// Y contribution to R,G,B.  Scale and bias.
#define YG 19003 /* round2(1.164384 * 64 * 256 * 256 / 257) */
...
#define UB 120 /* round2(1.881400 * 64) */
#define UG 11  /* round2(0.164553 * 64) */
#define VG 37  /* round2(0.571353 * 64) */
#define VR 94  /* round2(1.474600 * 64) */
