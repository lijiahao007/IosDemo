...
#define NV_LANGUAGE_ES              1101        //西班牙语
#define NV_LANGUAGE_FR              1102        //法语
#define NV_LANGUAGE_DE              1103        //德语
#define NV_LANGUAGE_IT              1104        //意大利语
#define NV_LANGUAGE_JP              1105        //日语
#define NV_LANGUAGE_KR              1106        //韩语
#define NV_LANGUAGE_RU              1107        //俄语
#define NV_LANGUAGE_PT              1108        //葡萄牙语
#define NV_LANGUAGE_AR              1109        //阿拉伯语
#define NV_LANGUAGE_FA              1110        //波斯语
#define NV_LANGUAGE_PL              1111        //波兰语
#define NV_LANGUAGE_ID              1112        //印度尼西亚语
#define NV_LANGUAGE_TH              1113        //泰语
#define NV_LANGUAGE_PH              1114        //菲律宾语
#define NV_LANGUAGE_VI              1115        //越南语
...
#define RECORD_STAT_SDCARD_FULL_ERR     -13     //录像状态: 空间不足
#define RECORD_STAT_SDCARD_FORMATTING   -14     //录像状态: 正在格式化
#define RECORD_STAT_SDCARD_UNINSTALL    -15     //录像状态: 卸载状态
#define RECORD_STAT_SDCARD_FORMAT       -16     //录像状态: 需要格式化

//MARK: 枪球联动设置
#define NV_IPC_LINK_AGE   189
...
#define ALARM_TYPE_STAY                     14      //逗留报警
#define ALARM_TYPE_AREA_IN                  15      //区域入侵报警
#define ALARM_TYPE_AREA_OUT                 16      //物品丢失报警
#define ALARM_TYPE_LINE_CROSS               17      //越线报警
#define ALARM_TYPE_POSITIVE_ALARM           18      //主动报警
#define ALARM_TYPE_VIDEO_CALL               19      //视频通话
#define ALARM_TYPE_Lowpower_OFF             102     //低功耗设备关机
#define ALARM_TYPE_Lowpower_ON              103     //低功耗设备开机
...
#define NV_RESULT_UPDATE_NOTSUPPORT         1030    // 当前状态不支持升级，需要接通电源才能升级
...
//MARK: 黑白全彩切换
#define NV_IPC_STAR_LIGHT_CONTROL            197     //图像全彩黑白设置CMD(发请求)NV_IPC_FULLCOLOR_SET_REQUEST
...
#define IPC_ZOOM_IN                             1000    //(变倍加)拉远
#define IPC_ZOOM_OUT                            1001    //(变倍减)拉近
#define IPC_ZOOM_LENS_IN                        1002    //变焦加
#define IPC_ZOOM_LENS_OUT                       1003    //变焦减
#define IPC_ZOOM_END                            1100    //变倍聚焦结束 add by qin 20210318
#define IPC_ZOOM_MILTIPLE                       1101    //设定变倍倍数（此时step表示变倍的倍数 如：15表示1.5倍）
#define IPC_ZOOM_LOCK                           1200    //锁焦
...
//MARK: 隐私权限设置
#define NV_IPC_SET_PRIVATE_MODE                 379     //隐私权限设置请求指令CMD
#define NV_IPC_SET_PRIVATE_MODE_RESPONSE        479     //隐私权限设置响应指令CMD

//MARK: 婴儿监视器
#define NV_IPC_BABY_MONITOR_CTRL_REQUEST        380     //婴儿监视器控制信息请求指令
#define NV_IPC_BABY_MONITOR_CTRL_RESPONSE       480     //婴儿监视器控制信息返回指令

#define NV_IPC_BABY_MONITOR_MUSIC_LIST_REQUEST   381 //获取安抚音乐列表请求指令
#define NV_IPC_BABY_MONITOR_MUSIC_LIST_RESPONSE  481  //获取安抚音乐列表返回指令

#define NV_IPC_BABY_MONITOR_ADD_MUSIC_REQUEST  382  //添加本地音乐请求指令
#define NV_IPC_BABY_MONITOR_ADD_MUSIC_RESPONSE  482  //添加本地音乐返回指令
#define NV_BABY_MONITOR_AUDIO_SEND              182     //自定义音乐发送指令CMD
#define NV_BABY_MONITOR_AUDIO_COMFIRM           282     //确认指令CMD

#define NV_IPC_BABY_MONITOR_DOWNLOAD_MUSIC_REQUEST  383  //下载在线音乐请求指令
#define NV_IPC_BABY_MONITOR_DOWNLOAD_MUSIC_RESPONSE  483  //下载在线音乐返回指令

#define NV_IPC_BABY_MONITOR_DEL_MUSIC_REQUEST  384  //删除安抚音乐请求指令
#define NV_IPC_BABY_MONITOR_DEL_MUSIC_RESPONSE  484  //删除安抚音乐返回指令

#define NV_IPC_BABY_MONITOR_PLAY_MUSIC_REQUEST  385  //开始/停止播放安抚音乐请求指令
#define NV_IPC_BABY_MONITOR_PLAY_MUSIC_RESPONSE  485  //开始/停止播放安抚音乐返回指令

//MARK: 电子围栏
#define NV_IPC_LINE_CROSSING_DETECT_SET_REQUEST  386 //越线检测设置请求指令
#define NV_IPC_LINE_CROSSING_DETECT_SET_RESPONSE 486 //越线检测设置返回指令
...
//MARK: 手机类型定义
//#define PHONE_TYPE_IOS                 看ConfigurationFile.h
